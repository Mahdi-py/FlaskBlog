...
from flask_blog.users.forms import (RegistrationForm, LoginForm, UpdateAcountForm,
...
def user_posts(username):
    page = request.args.get('page', 1, type=int)  # to identify the page number we want
    user = User.query.filter_by(username=username).first_or_404()
    posts = Post.query.filter_by(author=user) \
        .order_by(Post.date_posted.desc()) \
        .paginate(per_page=5, page=page)  # to identify how many posts per page
